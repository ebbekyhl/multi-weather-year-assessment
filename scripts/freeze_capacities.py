...
def freeze_network(n):
    ...
    df.loc[df_real.index,'p_nom_extendable'] = snakemake.config['generators_extendable']
    n.generators = df
    ...
    df.loc[df_real.index,'p_nom'] = df_real.p_nom_opt.values
    df.loc[df_real.index,'p_nom_extendable'] = snakemake.config['links_extendable']
    n.links = df
    ...
    df.loc[df_bat.index,'p_nom_extendable'] = snakemake.config['links_extendable']
    n.links = df
    ...
    df.loc[df_real.index,'e_nom_extendable'] = snakemake.config['stores_extendable'] 
    n.stores = df
